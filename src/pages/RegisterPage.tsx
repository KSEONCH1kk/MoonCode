...
export function RegisterPage() {
  const { register, loginWithOAuth, user, isLoading } = useAuth()
    ...
    <div className="min-h-[calc(100vh-64px)] flex items-center justify-center bg-gray-50 py-12 px-4">
      <div className="w-full max-w-[420px]">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl font-medium text-gray-900 mb-2">Создать аккаунт</h1>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <label className="flex items-start gap-3 cursor-pointer">
                ...
                <span className="text-sm text-gray-600">
                  Я принимаю{' '}
                  <a href="#" className="text-gray-900 hover:underline">условия использования</a>
                  {' '}и{' '}
                  <a href="#" className="text-gray-900 hover:underline">политику конфиденциальности</a>
                </span>
              </label>
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3.5 bg-gray-900 text-white rounded-xl font-medium hover:bg-gray-800 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
          ...
          <div className="space-y-3">
            ...
            >
              ...
              <span className="text-gray-700 text-sm font-medium">
                {oauthLoading === 'google' ? 'Подключение...' : 'Регистрация через Google'}
              </span>
            </button>
            ...
            >
              ...
              <span className="text-gray-700 text-sm font-medium">
                {oauthLoading === 'vk' ? 'Подключение...' : 'Регистрация через VK'}
              </span>
            </button>
            ...
            >
              ...
              <span className="text-gray-700 text-sm font-medium">
                {oauthLoading === 'github' ? 'Подключение...' : 'Регистрация через GitHub'}
              </span>
            </button>
          </div>
        </div>
        ...
        <div className="mt-8 grid grid-cols-3 gap-4 text-center">
          <div>
            <div className="text-2xl font-medium text-gray-900">4500+</div>
            <div className="text-xs text-gray-500">выпускников</div>
          </div>
          <div>
            <div className="text-2xl font-medium text-gray-900">80%</div>
            <div className="text-xs text-gray-500">трудоустройство</div>
          </div>
          <div>
            <div className="text-2xl font-medium text-gray-900">10+</div>
            <div className="text-xs text-gray-500">лет на рынке</div>
          </div>
        </div>
      </div>
    </div>
