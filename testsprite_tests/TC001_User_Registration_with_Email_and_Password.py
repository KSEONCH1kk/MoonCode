...
async def run_test():
    ...
    try:
        ...
        # Click on 'Регистрация' link to go to registration page
        elem = frame.locator('xpath=html/body/div/div/header/div/div/div[2]/a').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # -> Fill in the registration form with valid name, email, password, accept terms, and submit the form.
        frame = context.pages[-1]
        ...
        elem = frame.locator('xpath=html/body/div/div/main/div/div/div[2]/form/div[3]/div/input').nth(0)
        await page.wait_for_timeout(3000); await elem.fill('demo12345')
        

        frame = context.pages[-1]
        # Click checkbox to accept terms and privacy policy
        elem = frame.locator('xpath=html/body/div/div/main/div/div/div[2]/form/div[4]/label/input').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        ...
        try:
            ...
            raise AssertionError("Test case failed: The registration process did not complete successfully as expected. The success confirmation message was not found on the page, indicating the user registration failed.")
