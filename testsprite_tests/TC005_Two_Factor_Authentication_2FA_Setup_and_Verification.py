...
async def run_test():
    ...
    try:
        ...
        # Click on the 'Вход' (Login) link to navigate to login page.
        elem = frame.locator('xpath=html/body/div/div/header/div/div/div[2]/a[2]').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # -> Input email and password for user demo@mooncode.io and demo123, then click login button.
        frame = context.pages[-1]
        # Input email demo@mooncode.io
        ...
        # -> Try clicking the visible login button with index 15 labeled 'Войти' to submit the login form.
        frame = context.pages[-1]
        # Click the login button labeled 'Войти' to submit login form.
        elem = frame.locator('xpath=html/body/div/div/main/div/div/div[2]/form/button').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # -> Try clicking the other visible button with index 14 labeled 'Войти' to submit login form again.
        frame = context.pages[-1]
        # Click the login button labeled 'Войти' to submit login form.
        elem = frame.locator('xpath=html/body/div/div/main/div/div/div[2]/form/button').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        ...
        try:
            ...
            raise AssertionError("Test case failed: The test plan execution failed to verify enabling 2FA, receiving 2FA code, and completing login with code validation as expected.")
