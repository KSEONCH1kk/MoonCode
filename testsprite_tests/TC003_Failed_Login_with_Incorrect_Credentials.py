...
async def run_test():
    ...
    try:
        ...
        # -> Scroll down and inspect page for any hidden or dynamically displayed error messages or alerts related to invalid login attempt.
        await page.mouse.wheel(0, 200)
        

        # --> Assertions to verify final state
        frame = context.pages[-1]
        await expect(frame.locator('text=Вход в аккаунт').first).to_be_visible(timeout=30000)
