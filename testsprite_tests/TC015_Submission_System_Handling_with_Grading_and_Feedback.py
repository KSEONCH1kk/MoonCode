...
async def run_test():
    ...
    try:
        ...
        # -> Click on the 'Вход' (Login) link to proceed to the login page.
        ...
        # -> Input student email and password, then click the login button to log in as student.
        frame = context.pages[-1]
        # Input student email in the email field.
        ...
        frame = context.pages[-1]
        # Input student password in the password field.
        ...
        try:
            ...
            raise AssertionError("Test case failed: The test plan execution failed because the submission was not processed, graded, or feedback was not provided correctly. Expected to see a confirmation message 'Submission Successful!' which is not present on the page.")
