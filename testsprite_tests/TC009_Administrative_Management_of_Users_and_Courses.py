...
async def run_test():
    ...
    try:
        ...
        # -> Click on the 'Вход' (Login) link to start administrator login.
        frame = context.pages[-1]
        # Click on the 'Вход' (Login) link to open login form.
        ...
        try:
            ...
            raise AssertionError("Test case failed: Admin panel operations managing user roles, courses, and system settings could not be validated as the test plan execution failed.")
